...
namespace Utf8Json.Resolvers.Internal
{
...
#endif
    {
        ...
        public static readonly IJsonFormatterResolver Instance = 
            new DynamicObjectResolverAllowPrivateFalseExcludeNullFalseNameMutateSnakeCase();
        static readonly Func<string, string> nameMutator = StringMutator.ToSnakeCase;
        static readonly bool excludeNull = false;
        const string ModuleName = 
            "Utf8Json.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullFalseNameMutateSnakeCase";
...
#endif
    {
        // configuration
        public static readonly IJsonFormatterResolver Instance = 
            new DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateOriginal();
        static readonly Func<string, string> nameMutator = StringMutator.Original;
        static readonly bool excludeNull = true;
        const string ModuleName = 
            "Utf8Json.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateOriginal";
        ...
        static class FormatterCache<T>
        {
            ...
            static FormatterCache()
            {
                formatter = (IJsonFormatter<T>)DynamicObjectTypeBuilder
                    .BuildFormatterToAssembly<T>(assembly, Instance, nameMutator, excludeNull);
            }
        }
    }
...
#endif
    {
        // configuration
        public static readonly IJsonFormatterResolver Instance = 
            new DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateCamelCase();
        static readonly Func<string, string> nameMutator = StringMutator.ToCamelCase;
        static readonly bool excludeNull = true;
        const string ModuleName = 
            "Utf8Json.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateCamelCase";
    ...
    internal sealed class DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateSnakeCase 
...
#endif
    {
        // configuration
        public static readonly IJsonFormatterResolver Instance = 
            new DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateSnakeCase();
        static readonly Func<string, string> nameMutator = StringMutator.ToSnakeCase;
        static readonly bool excludeNull = true;
        const string ModuleName = 
            "Utf8Json.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateSnakeCase";
        ...
        static class FormatterCache<T>
        {
            ...
            static FormatterCache()
            {
                formatter = (IJsonFormatter<T>)DynamicObjectTypeBuilder.BuildFormatterToAssembly<T>
                    (assembly, Instance, nameMutator, excludeNull);
            }
        }
    }
    ...
    internal sealed class DynamicObjectResolverAllowPrivateTrueExcludeNullFalseNameMutateOriginal 
        : IJsonFormatterResolver
    {
        // configuration
        public static readonly IJsonFormatterResolver Instance = 
            new DynamicObjectResolverAllowPrivateTrueExcludeNullFalseNameMutateOriginal();
        static readonly Func<string, string> nameMutator = StringMutator.Original;
        static readonly bool excludeNull = false;
    ...
    internal sealed class DynamicObjectResolverAllowPrivateTrueExcludeNullFalseNameMutateCamelCase : IJsonFormatterResolver
    {
        // configuration
        public static readonly IJsonFormatterResolver Instance = 
            new DynamicObjectResolverAllowPrivateTrueExcludeNullFalseNameMutateCamelCase();
        static readonly Func<string, string> nameMutator = StringMutator.ToCamelCase;
        static readonly bool excludeNull = false;
        ...
        static class FormatterCache<T>
        {
            ...
            static FormatterCache()
            {
                formatter = (IJsonFormatter<T>)
                    DynamicObjectTypeBuilder.BuildFormatterToDynamicMethod<T>(
                        Instance, nameMutator, excludeNull, true);
            }
        }
    }

    internal sealed class DynamicObjectResolverAllowPrivateTrueExcludeNullFalseNameMutateSnakeCase
        : IJsonFormatterResolver
    {
        // configuration
        public static readonly IJsonFormatterResolver Instance = 
            new DynamicObjectResolverAllowPrivateTrueExcludeNullFalseNameMutateSnakeCase();
        static readonly Func<string, string> nameMutator = StringMutator.ToSnakeCase;
        static readonly bool excludeNull = false;
        ...
        static class FormatterCache<T>
        {
            ...
            {
                formatter = (IJsonFormatter<T>)DynamicObjectTypeBuilder
                    .BuildFormatterToDynamicMethod<T>(Instance, nameMutator, excludeNull, true);
            }
        }
    }

    internal sealed class DynamicObjectResolverAllowPrivateTrueExcludeNullTrueNameMutateOriginal 
        : IJsonFormatterResolver
    {
        // configuration
        public static readonly IJsonFormatterResolver Instance = 
            new DynamicObjectResolverAllowPrivateTrueExcludeNullTrueNameMutateOriginal();
        static readonly Func<string, string> nameMutator = StringMutator.Original;
        static readonly bool excludeNull = true;
    ...
    internal sealed class DynamicObjectResolverAllowPrivateTrueExcludeNullTrueNameMutateCamelCase 
        : IJsonFormatterResolver
    {
        // configuration
        public static readonly IJsonFormatterResolver Instance = 
            new DynamicObjectResolverAllowPrivateTrueExcludeNullTrueNameMutateCamelCase();
        static readonly Func<string, string> nameMutator = StringMutator.ToCamelCase;
        static readonly bool excludeNull = true;
    ...
    internal sealed class DynamicObjectResolverAllowPrivateTrueExcludeNullTrueNameMutateSnakeCase
        : IJsonFormatterResolver
    {
        // configuration
        public static readonly IJsonFormatterResolver Instance =
            new DynamicObjectResolverAllowPrivateTrueExcludeNullTrueNameMutateSnakeCase();
        static readonly Func<string, string> nameMutator = StringMutator.ToSnakeCase;
        static readonly bool excludeNull = true;
    ...
    internal static class DynamicObjectTypeBuilder
    {
        ...
        public static object BuildFormatterToAssembly<T>(DynamicAssembly assembly, 
            IJsonFormatterResolver selfResolver, Func<string, string> nameMutator, bool excludeNull)
        {
            ...
            if (ti.IsNullable())
            {
                ...
                return (IJsonFormatter<T>)Activator.CreateInstance(
                    typeof(StaticNullableFormatter<>).MakeGenericType(ti.AsType()), new object[] 
                    { innerFormatter });
            }
            ...
            {
                return DynamicObjectTypeBuilder.BuildAnonymousFormatter(typeof(T),
                    nameMutator, excludeNull, false, true);
            }
            ...
            var formatterTypeInfo = DynamicObjectTypeBuilder.BuildType(assembly, typeof(T),
                nameMutator, excludeNull);
            if (formatterTypeInfo == null) return null;

            return (IJsonFormatter<T>)Activator.CreateInstance(formatterTypeInfo.AsType());
        }

        public static object BuildFormatterToDynamicMethod<T>(IJsonFormatterResolver selfResolver,
            Func<string, string> nameMutator, bool excludeNull, bool allowPrivate)
        {
            var ti = typeof(T).GetTypeInfo();
            ...
            if (ti.IsNullable())
            {
                ...
                return (IJsonFormatter<T>)Activator.CreateInstance(typeof(StaticNullableFormatter<>)
                    .MakeGenericType(ti.AsType()), new object[] { innerFormatter });
            }
            if (typeof(Exception).GetTypeInfo().IsAssignableFrom(ti))
            {
                return DynamicObjectTypeBuilder.BuildAnonymousFormatter(typeof(T), nameMutator,
                    excludeNull, false, true);
            }
            else
            {
                return DynamicObjectTypeBuilder.BuildAnonymousFormatter(typeof(T), nameMutator, 
                    excludeNull, allowPrivate, false);
            }
        }

        static TypeInfo BuildType(DynamicAssembly assembly, Type type,
            Func<string, string> nameMutator, bool excludeNull)
        {
            if (ignoreTypes.Contains(type)) return null;

            var serializationInfo = new MetaType(type, nameMutator, false); // allowPrivate:false
            var hasShouldSerialize = serializationInfo.Members.Any(
                x => x.ShouldSerializeMethodInfo != null);

            var formatterType = typeof(IJsonFormatter<>).MakeGenericType(type);
            var typeBuilder = assembly.DefineType("Utf8Json.Formatters." 
                + SubtractFullNameRegex.Replace(type.FullName, "").Replace(".", "_") + "Formatter"
                + Interlocked.Increment(ref nameSequence), TypeAttributes.Public | TypeAttributes.Sealed,
                null, new[] { formatterType });
            ...
            {
                var method = typeBuilder.DefineConstructor(MethodAttributes.Public, 
                    CallingConventions.Standard, Type.EmptyTypes);
                stringByteKeysField = typeBuilder.DefineField("stringByteKeys",
                    typeof(byte[][]), FieldAttributes.Private | FieldAttributes.InitOnly);

                var il = method.GetILGenerator();
                customFormatterLookup = BuildConstructor(typeBuilder, serializationInfo, 
                    method, stringByteKeysField, il, excludeNull, hasShouldSerialize);
            }

            {
                var method = typeBuilder.DefineMethod("Serialize", 
                    ...
                    null,
                    new Type[] { typeof(JsonWriter).MakeByRefType(), type,
        ...
        public static object BuildAnonymousFormatter(Type type, Func<string, string> nameMutator, 
            bool excludeNull, bool allowPrivate, bool isException)
        {
            ...
            if (isException)
            {
                ...
                {
                    "HelpLink", "TargetSite", "HResult", "Data", "ClassName",
                    "InnerException"
                ...
                serializationInfo.Members = new[] { new StringConstantValueMetaMember(
                    nameMutator("ClassName"), type.FullName) }
            ...
            var serialize = new DynamicMethod("Serialize", null, new Type[] { typeof(byte[][]), typeof(object[]), typeof(JsonWriter).MakeByRefType(), type, typeof(IJsonFormatterResolver) },
                type.GetTypeInfo().Module, true);
            {
            ...
            var deserialize = new DynamicMethod("Deserialize", type, new Type[] { typeof(object[]), 
                typeof(JsonReader).MakeByRefType(),
                typeof(IJsonFormatterResolver) }, type.GetTypeInfo().Module, true);
            {
                ...
                if (excludeNull || hasShouldSerialize)
                {
                    ...
                    if (excludeNull)
                    {
                        if (item.Type.GetTypeInfo().IsNullable())
                        {
                            ...
                            il.EmitStloc(local);
                            il.EmitLdloca(local);
                            il.EmitCall(EmitInfo.GetNullableHasValue(item.Type.GetTypeInfo().GenericTypeArguments[0]));
                            il.Emit(OpCodes.Brfalse_S, (index < labels.Length - 1) ? labels[index + 1] : endObjectLabel); // null, next label
                        }
                        else if (!item.Type.GetTypeInfo().IsValueType && !(item is StringConstantValueMetaMember))
                        {
                            argValue.EmitLoad();
                            item.EmitLoadValue(il);
                            il.Emit(OpCodes.Brfalse_S, (index < labels.Length - 1) ? labels[index + 1] : endObjectLabel); // null, next label
        ...
        static void BuildDeserialize(Type type, MetaType info, ILGenerator il, Func<int, MetaMember, bool> tryEmitLoadCustomFormatter, bool useGetUninitializedObject, int firstArgIndex)
        {
            ...
            // read member loop
            {
                ...
                il.EmitCall(typeof(ArraySegment<byte>).GetRuntimeProperty("Offset").GetGetMethod(true));
                il.Emit(OpCodes.Add);
                il.EmitStloc(p);

                // rest = arraySegment.Count
                il.EmitLdloca(keyArraySegment);
                il.EmitCall(typeof(ArraySegment<byte>).GetRuntimeProperty("Count").GetGetMethod(true));
                il.EmitStloc(rest);
        ...
        static LocalBuilder EmitNewObject(ILGenerator il, Type type, MetaType info, DeserializeInfo[] members, bool isSideEffectFreeType)
        {
            if (info.IsClass)
            {
                ...
                else
                {
                    ...
                    il.EmitCall(EmitInfo.GetTypeFromHandle);
                    //il.EmitCall(EmitInfo.GetUninitializedObject);//FIXIT
                }
                if (!isSideEffectFreeType)
                {
                    il.EmitStloc(result);
        ...
        static bool IsSideEffectFreeConstructorType(ConstructorInfo ctorInfo)
        {
            //FIXIT
            /*
            var methodBody = ctorInfo.GetTypeInfo().GetMethodBody();
            if (methodBody == null) return false; // can't analysis

            var array = methodBody.GetTypeInfo().GetILAsByteArray();
            ...
            {
                if (ctorInfo.DeclaringType.GetTypeInfo().BaseType == typeof(object))
                {
                    return true;
                }
                else
                {
                    ...
                    var bassCtorInfo = ctorInfo.DeclaringType.GetTypeInfo().BaseType.GetConstructor(Type.EmptyTypes);
        ...
        {
            foreach (Type implInterface in type.GetTypeInfo().ImplementedInterfaces)
            {
                if (implInterface.GetTypeInfo().IsGenericType)
                {
                    Type genericTypeDef = implInterface.GetGenericTypeDefinition();
                    if (genericTypeDef == typeof(IEnumerable<>))
                    {
                        Type[] args = implInterface.GetTypeInfo().GenericTypeArguments;//.GetGenericArguments();
                        elementType = args[0];
                        return true;
                    }
                }
        ...
        internal static class EmitInfo
        {
            public static readonly ConstructorInfo ObjectCtor 
                = typeof(object).GetTypeInfo().DeclaredConstructors.First(
                    x => x.GetParameters().Length == 0);

            public static readonly MethodInfo GetFormatterWithVerify 
                = typeof(JsonFormatterResolverExtensions).GetRuntimeMethod("GetFormatterWithVerify", 
                    new[] { typeof(IJsonFormatterResolver) });
#if NETSTANDARD
            public static readonly MethodInfo UnsafeMemory_MemoryCopy 
                = ExpressionUtility.GetMethodInfo((Utf8Json.JsonWriter writer, byte[] src) 
                    => UnsafeMemory.MemoryCopy(ref writer, src));
#endif
            public static readonly ConstructorInfo InvalidOperationExceptionConstructor 
                = typeof(System.InvalidOperationException).GetTypeInfo().DeclaredConstructors
                .First(x => { var p = x.GetParameters(); 
                    return p.Length == 1 && p[0].ParameterType == typeof(string); });

            public static readonly MethodInfo GetTypeFromHandle = ExpressionUtility.GetMethodInfo(() 
                => Type.GetTypeFromHandle(default(RuntimeTypeHandle)));

            public static readonly MethodInfo TypeGetProperty = ExpressionUtility.GetMethodInfo((Type t) 
                => t.GetTypeInfo().GetDeclaredProperty(default(string)));

            public static readonly MethodInfo TypeGetField = ExpressionUtility.GetMethodInfo((Type t)
                => t.GetTypeInfo().GetDeclaredField(default(string)));
            ...
            public static readonly MethodInfo ActivatorCreateInstance = ExpressionUtility.GetMethodInfo(() 
                => Activator.CreateInstance(default(Type), default(object[])));

            //FIXIT
            //public static readonly MethodInfo GetUninitializedObject = ExpressionUtility.GetMethodInfo(() 
            //    => System.Runtime.Serialization.FormatterServices.GetUninitializedObject(default(Type)));
            ...
            {
                return typeof(IJsonFormatter<>).MakeGenericType(type).GetRuntimeMethod(
                    "Serialize", new[] { typeof(Utf8Json.JsonWriter).MakeByRefType(), 
                        type, typeof(IJsonFormatterResolver) });
            }

            public static MethodInfo Deserialize(Type type)
            {
                return typeof(IJsonFormatter<>).MakeGenericType(type).GetRuntimeMethod("Deserialize", 
            ...
            {
                return typeof(Nullable<>).MakeGenericType(type).GetRuntimeProperty("HasValue")
                    .GetGetMethod(true);
            }
            ...
            internal static class JsonWriter
            {
                public static readonly MethodInfo GetEncodedPropertyNameWithBeginObject 
                    = ExpressionUtility.GetMethodInfo(() 
                        => Utf8Json.JsonWriter.GetEncodedPropertyNameWithBeginObject(default(string)));

                public static readonly MethodInfo GetEncodedPropertyNameWithPrefixValueSeparator 
                    = ExpressionUtility.GetMethodInfo(()
                        => Utf8Json.JsonWriter.GetEncodedPropertyNameWithPrefixValueSeparator(default(string)));

                public static readonly MethodInfo GetEncodedPropertyNameWithoutQuotation 
                    = ExpressionUtility.GetMethodInfo(() 
                        => Utf8Json.JsonWriter.GetEncodedPropertyNameWithoutQuotation(default(string)));

                public static readonly MethodInfo GetEncodedPropertyName 
                    = ExpressionUtility.GetMethodInfo(() => Utf8Json.JsonWriter.GetEncodedPropertyName(
                        default(string)));

                public static readonly MethodInfo WriteNull = ExpressionUtility.GetMethodInfo(
                    (Utf8Json.JsonWriter writer) => writer.WriteNull());

                public static readonly MethodInfo WriteRaw = ExpressionUtility.GetMethodInfo(
                    (Utf8Json.JsonWriter writer) => writer.WriteRaw(default(byte[])));

                public static readonly MethodInfo WriteBeginObject = ExpressionUtility.GetMethodInfo(
                    (Utf8Json.JsonWriter writer) => writer.WriteBeginObject());

                public static readonly MethodInfo WriteEndObject = ExpressionUtility.GetMethodInfo(
                    (Utf8Json.JsonWriter writer) => writer.WriteEndObject());

                public static readonly MethodInfo WriteValueSeparator = ExpressionUtility.GetMethodInfo(
                    (Utf8Json.JsonWriter writer) => writer.WriteValueSeparator());
            ...
            internal static class JsonReader
            {
                public static readonly MethodInfo ReadIsNull 
                    = ExpressionUtility.GetMethodInfo((Utf8Json.JsonReader reader)
                        => reader.ReadIsNull());
                ...
                public static readonly MethodInfo ReadIsEndObjectWithSkipValueSeparator 
                    = ExpressionUtility.GetMethodInfo((Utf8Json.JsonReader reader, int count) 
                        => reader.ReadIsEndObjectWithSkipValueSeparator(ref count));
                public static readonly MethodInfo ReadPropertyNameSegmentUnsafe 
                    = ExpressionUtility.GetMethodInfo((Utf8Json.JsonReader reader) 
                        => reader.ReadPropertyNameSegmentRaw());
            ...
            internal static class JsonFormatterAttr
            {
                internal static readonly MethodInfo FormatterType = 
                    ExpressionUtility.GetPropertyInfo((Utf8Json.JsonFormatterAttribute attr) 
                        => attr.FormatterType).GetGetMethod(true);
                internal static readonly MethodInfo Arguments 
                    = ExpressionUtility.GetPropertyInfo((Utf8Json.JsonFormatterAttribute attr) 
                        => attr.Arguments).GetGetMethod(true);
            }
        }
    ...
    internal delegate void AnonymousJsonSerializeAction<T>(
        byte[][] stringByteKeysField, object[] customFormatters, ref JsonWriter writer,
        T value, IJsonFormatterResolver resolver);
    internal delegate T AnonymousJsonDeserializeFunc<T>(
        object[] customFormatters, ref JsonReader reader, IJsonFormatterResolver resolver);
    ...
    internal class DynamicMethodAnonymousFormatter<T> : IJsonFormatter<T>
    {
        ...
        public DynamicMethodAnonymousFormatter(byte[][] stringByteKeysField, 
            object[] serializeCustomFormatters, object[] deserializeCustomFormatters,
        ...
        {
            if (serialize == null) throw new InvalidOperationException(this.GetType().Name
        ...
        {
            if (deserialize == null) throw new InvalidOperationException(this.GetType().Name 
