        ...
        public static class NonGeneric
        {
            ...
            class CompiledMethods
            {
                ...
                public CompiledMethods(Type type)
                {
                    ...
                    {
                        var dm = new DynamicMethod("serialize3", null, new[] { typeof(JsonWriter).MakeByRefType(), typeof(object),
                    ...
                    {
                        var dm = new DynamicMethod("Deserialize", typeof(object), new[] 
                        { 
                        ...
                        il.EmitLdarg(1);
                        il.EmitLdarg(2);
                        il.EmitCall(GetMethod(type, "Deserialize", new[] { typeof(byte[]), typeof(int), 
                            typeof(IJsonFormatterResolver) }));
                        il.EmitBoxOrDoNothing(type);
                        il.Emit(OpCodes.Ret);
                    ...
                    {
                        var dm = new DynamicMethod("Deserialize", typeof(object), new[] { typeof(Stream),
                            typeof(IJsonFormatterResolver) }, 
                            type.GetTypeInfo().Module, true);
                        var il = dm.GetILGenerator();
                    ...
                    {
                        var dm = new DynamicMethod("Deserialize", typeof(object), new[] { typeof(JsonReader).MakeByRefType(), typeof(IJsonFormatterResolver) },
                            type.GetTypeInfo().Module, true);
                        var il = dm.GetILGenerator();
                    ...
                    {
                        var dm = new DynamicMethod("SerializeAsync", typeof(System.Threading.Tasks.Task), new[] { typeof(Stream), typeof(object), typeof(IJsonFormatterResolver) }, 
                            type.GetTypeInfo().Module, true);
                        var il = dm.GetILGenerator();
                    ...
                    {
                        var dm = new DynamicMethod("DeserializeAsync", typeof(System.Threading.Tasks.Task<object>), new[] { typeof(Stream), typeof(IJsonFormatterResolver) }, 
                            type.GetTypeInfo().Module, true);
                        var il = dm.GetILGenerator();
                        ...
                        il.EmitCall(typeof(CompiledMethods).GetTypeInfo().GetDeclaredMethod("TaskCast").MakeGenericMethod(type));
                        il.Emit(OpCodes.Ret);
                ...
                {
                    return typeof(JsonSerializer).GetTypeInfo().GetDeclaredMethods(name)
                        .Where(x => x.Name == name)
                        .Single(x =>
                        {
